      ...
      <div className="bg-white rounded-xl p-4 shadow-sm border border-umber-200 w-full">
        <div className="relative h-56 flex items-center justify-center">
          ...
          >
            ...
            {/* Center to Living Room - Straight line */}
            ...
            {/* Center to Kitchen - Straight line */}
            ...
            {/* Center to Outdoor - Straight line */}
            ...
            {/* Center to Bedroom - Straight line */}
        ...
        <div className="text-xs text-umber-600 text-center mt-2">
          Home Tech mind map with connected areas
        </div>
      </div>
    ),
  },
